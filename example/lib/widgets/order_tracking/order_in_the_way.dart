...
class _OrderOnTheWayState extends State<OrderOnTheWay> {
  ...
  Widget build(BuildContext context) {
    ...
    return language=="en"?Image.asset("images/new order tracking english/OrderIsOnTheWay.jpg",height: MediaQuery.of(context).size.height*0.75,fit:BoxFit.contain):Image.asset("images/order trackingArabic/4.png",height: MediaQuery.of(context).size.height*0.75,fit:BoxFit.contain);
    // Expanded(
    //   child: Container(
