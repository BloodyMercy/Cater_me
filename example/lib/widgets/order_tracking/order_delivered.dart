...
class _OrderDeliveredState extends State<OrderDelivered> {
  ...
  Widget build(BuildContext context) {
    ...
    return
      language=="en"?Image.asset("images/new order tracking english/OrderDelivered.png",height: MediaQuery.of(context).size.height*0.80,fit:BoxFit.contain):Image.asset('images/order trackingArabic/5.png',height: MediaQuery.of(context).size.height*0.80,fit:BoxFit.contain);
    //   Expanded(
    //   child: Container(
