...
class _OTPPending extends State<OTPPending> {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: language=="en"?Image.asset("images/new order tracking english/OTPPending.jpg",fit:BoxFit.contain,height: MediaQuery.of(context).size.height*0.75):Image.asset("images/order trackingArabic/1.png",height: MediaQuery.of(context).size.height*0.75,fit:BoxFit.contain));
    // Expanded(
    //   child: Container(
