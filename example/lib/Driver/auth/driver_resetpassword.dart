import 'package:CaterMe/Driver/auth/driver_confirm_email.dart';
...
class DriverResetPassword extends StatefulWidget {
  const DriverResetPassword({Key key}) : super(key: key);

  @override
  _DriverResetPasswordState createState() => _DriverResetPasswordState();
}
...
bool loading=false;
  ...
  final _scaffolddriver = GlobalKey<ScaffoldState>();
  @override
                        ...
                        async {
                          ...
                          if (formkey.currentState.validate() == false) {
                            ...
                            if (await authprovider.forgetpassword()) {
                              ...
                              _scaffolddriver.currentState.showSnackBar(
                                SnackBar(
                                  content: Text(
                                      "error try again"),
                                ),
