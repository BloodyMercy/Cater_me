...
class _TermsAndConditionsState extends State<TermsAndConditions> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
      ...
      body: ListView.builder(itemCount: 3, itemBuilder: (context, index) =>Container(
        ...
        child: Column(children: [
          ...
          t[index].checked
            ...
            child: Text(t[index].body, style: TextStyle(color: Colors.black, fontSize: 15),)
          )
              : Container(),
        ],),
      )),
