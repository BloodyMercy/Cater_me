...
class CustomStepperOrder extends StatefulWidget {
 // final Function onTap;
  final List<String> text;
  //final ScrollController controller;
  int selected;
  CustomStepperOrder({required this.text,this.selected=0}){
...
class _CustomStepperState extends State<CustomStepperOrder> {
  List<GlobalKey> keys=[];
