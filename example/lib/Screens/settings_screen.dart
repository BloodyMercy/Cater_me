            ...
            child: Container(
              ...
              child: Column(
                children: [
                        ...
                        child: GestureDetector(
                          ...
                          child: Row(
                            ...
                            Row(children: [
                              ...
                              Text("Personal Info", style: TextStyle(color: Colors.black, fontSize: 25, fontFamily:  'BerlinSansFB'),),],),
                        ...
                        child: GestureDetector(
                          ...
                          child: Row(
                            ...
                            Row(children: [
                              ...
                              SizedBox(width: mediaQuery.size.width*0.05,),
                              Text("Addresses", style: TextStyle(color: Colors.black, fontSize: 25, fontFamily:  'BerlinSansFB'),),],),
                              Row(children: [Icon(Icons.arrow_forward),
                                SizedBox(width: mediaQuery.size.width*0.03,),
                              ]),
                          ],),),
                        ...
                        child: GestureDetector(
                          ...
                          child: Row(
                            ...
                            Row(children: [
                              ...
                              SizedBox(width: mediaQuery.size.width*0.05,),
                              Text("Account Info", style: TextStyle(color: Colors.black, fontSize: 25, fontFamily:  'BerlinSansFB'),),
                            ],),
                              Row(children: [Icon(Icons.arrow_forward),
                                SizedBox(width: mediaQuery.size.width*0.03,),
                              ]),                          ],),),
                        ...
                        child: GestureDetector(
                          ...
                          child: Row(
                            ...
                            Row(children: [
                              ...
                              Icon(Icons.email),
                              SizedBox(width: mediaQuery.size.width*0.05,),
                              Text("Contact Us", style: TextStyle(color: Colors.black, fontSize: 25, fontFamily:  'BerlinSansFB'),),
                            ],),
                            Row(children: [Icon(Icons.arrow_forward),
                              SizedBox(width: mediaQuery.size.width*0.03,),
                            ]),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Row(children: [
                                ...
                                SizedBox(width: mediaQuery.size.width*0.05,),
                                Text("Add Friends", style: TextStyle(color: Colors.black, fontSize: 25, fontFamily:  'BerlinSansFB'),),
                              ],),
                              Row(children: [Icon(Icons.arrow_forward),
                                SizedBox(width: mediaQuery.size.width*0.03,),
                              ]),
                  ...
                  );}, child: Text("Log Out", style: Theme.of(context).textTheme.headline1,),
